"""
Modulo vista:
    En este modulo se crea la interfaz de usuario a traves de **Tkinter**.
"""
from tkinter import *
...
class Vista:
    """
    En la clase **Vista** se encuentran todas las variables o atributos de instancia que generan la interfaz al instanciarse en el modulo **controlador**.
    """
